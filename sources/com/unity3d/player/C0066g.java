...
public final class C0066g extends View {
    ...
    static /* synthetic */ class C00671 {
        ...
        static {
            /*
                int[] r0 = com.unity3d.player.C0066g.C0068a.m106a()
                int r0 = r0.length
                int[] r0 = new int[r0]
                f196a = r0
                r1 = 1
                int r2 = com.unity3d.player.C0066g.C0068a.f197a     // Catch:{ NoSuchFieldError -> 0x000f }
                int r2 = r2 - r1
                r0[r2] = r1     // Catch:{ NoSuchFieldError -> 0x000f }
            L_0x000f:
                int[] r0 = f196a     // Catch:{ NoSuchFieldError -> 0x0017 }
                int r2 = com.unity3d.player.C0066g.C0068a.f198b     // Catch:{ NoSuchFieldError -> 0x0017 }
                int r2 = r2 - r1
                r3 = 2
                r0[r2] = r3     // Catch:{ NoSuchFieldError -> 0x0017 }
            L_0x0017:
                int[] r0 = f196a     // Catch:{ NoSuchFieldError -> 0x001f }
                int r2 = com.unity3d.player.C0066g.C0068a.f199c     // Catch:{ NoSuchFieldError -> 0x001f }
                int r2 = r2 - r1
                r1 = 3
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.unity3d.player.C0066g.C00671.<clinit>():void");
        }
    }
    ...
    enum C0068a {
        ...
        /* renamed from: a */
        public static int[] m106a() {
            return (int[]) f200d.clone();
        }
    }

    public C0066g(Context context, int i) {
        super(context);
        this.f192a = i;
        int identifier = getResources().getIdentifier("unity_static_splash", "drawable", getContext().getPackageName());
        this.f193b = identifier;
        if (identifier != 0) {
            forceLayout();
        }
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        Bitmap bitmap = this.f194c;
        if (bitmap != null) {
            bitmap.recycle();
            this.f194c = null;
        }
        Bitmap bitmap2 = this.f195d;
        if (bitmap2 != null) {
            bitmap2.recycle();
            this.f195d = null;
        }
    ...
    public final void onLayout(boolean r9, int r10, int r11, int r12, int r13) {
        /*
            ...
            return
        L_0x0005:
            android.graphics.Bitmap r9 = r8.f194c
            r10 = 0
        ...
        L_0x001d:
            android.graphics.Bitmap r9 = r8.f194c
            int r9 = r9.getWidth()
            android.graphics.Bitmap r11 = r8.f194c
        ...
        L_0x0045:
            r3 = r10
        L_0x0046:
            int[] r5 = com.unity3d.player.C0066g.C00671.f196a
            int r6 = r8.f192a
            int r6 = r6 - r4
            r5 = r5[r6]
            r6 = 2
        ...
        L_0x0056:
            int r9 = r8.f192a
            int r11 = com.unity3d.player.C0066g.C0068a.f199c
        ...
        L_0x006d:
            ...
            r11 = r13
        L_0x0070:
            android.graphics.Bitmap r12 = r8.f195d
        ...
        L_0x0083:
            android.graphics.Bitmap r12 = r8.f195d
            android.graphics.Bitmap r13 = r8.f194c
            if (r12 == r13) goto L_0x008f
            r12.recycle()
            r12 = 0
            r8.f195d = r12
        L_0x008f:
            android.graphics.Bitmap r12 = r8.f194c
            ...
            android.graphics.Bitmap r13 = r8.f195d
            r11.<init>(r12, r13)
            r12 = 17
            r11.setGravity(r12)
        ...
        L_0x00c9:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.unity3d.player.C0066g.onLayout(boolean, int, int, int, int):void");
    }
}
